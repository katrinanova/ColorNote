...
user.notebooks.find(3).notes.create!(title: "Scaling Issues", color: "Blue", body: "Lets start by defining few terms to create common understanding and vocabulary. Later on I will go through different issues that pop-up while scaling web application like Architecture bottlenecks\r\n
Scaling Database\r\n
...
user.notebooks.find(3).notes.create!(title: "React.js vs traditional MVC (Backbone, Angular)", body: "I've been working with React for the last two weeks, and I think it's quite a revolutionary library. In this blog, I will tell you why.\r\n
